...
def main():
    ...
    # ── 2019–2020 gap note (plain text, no shading) ───────────────────────────
    ax.text(pd.Timestamp("2020-02-15"), -17,
            "Jan–Mar 2020 YoY\nunavailable\n(data from Apr 2019)",
            fontsize=6.5, color="#888888", ha="center", va="top",
            style="italic")
    ...
    ax.set_title(
        "Iran Steel Output: Year-over-Year Monthly Growth Rate\n"
        "Model predictions vs WSA benchmarks — 2022 energy rationing annotated",
